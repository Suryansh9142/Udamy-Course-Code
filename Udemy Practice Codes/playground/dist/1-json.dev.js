...
// After commenting out the all privious code then we run the readFileSync ( ) command to read the (.json) file that we created with the help of privious code .
...
console.log(data); // In terminal :- node 1-json.js